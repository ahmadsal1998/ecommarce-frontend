				...
				<List>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<EscSvgIcon>material-outline:notifications</EscSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<EscSvgIcon>material-outline:cloud</EscSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-40">
							<EscSvgIcon>material-outline:brightness_high</EscSvgIcon>
						</ListItemIcon>
