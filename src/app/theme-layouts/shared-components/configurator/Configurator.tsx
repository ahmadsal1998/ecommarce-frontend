...
import { usePrevious } from '@esc/hooks';
	...
	return (
		<>
			...
			>
				...
				>
					<span>
						<EscSvgIcon size={20}>heroicons-solid:cog</EscSvgIcon>
					</span>
				</Button>
				...
				<Button
					...
					disableRipple
				>
					<EscSvgIcon size={20}>heroicons-outline:color-swatch</EscSvgIcon>
				</Button>
			</Root>
