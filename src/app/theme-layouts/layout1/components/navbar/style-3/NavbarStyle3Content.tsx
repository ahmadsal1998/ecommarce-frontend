...
import { selectContrastMainTheme } from '@esc/core/EscSettings/store/escSettingsSlice';
...
const StyledPanel = styled(EscScrollbars)<StyledPanelProps>(({ theme, opened }) => ({
	backgroundColor: theme.palette.background.default,
	color: theme.palette.text.primary,
...
function NavbarStyle3Content(props: NavbarStyle3ContentProps) {
	...
	const [selectedNavigation, setSelectedNavigation] = useState<EscNavItemType[]>([]);
	...
	function handleParentItemClick(selected: EscNavItemType) {
