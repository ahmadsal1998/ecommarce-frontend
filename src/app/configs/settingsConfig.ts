...
/**
 * The settingsConfig object is a configuration object for the Esc application's settings.
 */
const settingsConfig: EscSettingsConfigType = {
	/**
	...
	theme: {
		...
		navbar: themesConfig.defaultNav,
