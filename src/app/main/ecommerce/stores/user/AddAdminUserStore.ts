...
type AppRootStateType = RootStateType<addAdminUserSliceType>;
...
export const addAdminUserSlice = createSlice({
	name: 'addAdminuser',
	initialState,
	reducers: {
...
export const { setUser, setName, setEmail, setMobile, setPassword, checkformValidation, forUserUpdate, clearForm, addNewUser, userDialogOpen  } = addAdminUserSlice.actions;
export const selectAdAdminUserLice = appSelector(({ addAdminuser }: AppRootStateType) => addAdminuser);

export type addAdminUserSliceType = typeof addAdminUserSlice;
