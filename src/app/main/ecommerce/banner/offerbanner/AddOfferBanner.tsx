...
import {
	...
	cleanForm,
	selectAddOfferBannerSlice,
	setImage,
	setName,
	validateForm
} from '../../stores/banners/AddOfferBannerStore';
import { addOfferBanner, updateOfferBannerById } from '../../respositories/banners/OfferBannerRepo';
...
function AddOfferBanner() {
	...
	const banner = useSelector(selectAddOfferBannerSlice);
						...
						<div className="flex  sm:flex-row flex-1 w-full items-end  justify-between space-y-8 sm:space-y-0 py-10 sm:py-24 px-24 md:px-24">
							<div className="grow">
								...
								<Typography className="mt-10 text-2xl font-extrabold leading-tight tracking-tight ">
									{banner.forUpdate ? 'Offer Banner Image details' : 'New Offer Banner Image'}
								</Typography>
							</div>
...
export default withSlices([addOfferBannerSlice])(memo(AddOfferBanner));
