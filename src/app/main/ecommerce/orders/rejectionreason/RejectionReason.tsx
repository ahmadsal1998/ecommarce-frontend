...
import Rejectlist from './RejectionsList';
import { rejectionReasonSlice, selectRejectionReasonSlice } from '../../stores/orders/rejectionReasonStore';
...
function OrderRejection() {
	const rejection = useSelector(selectRejectionReasonSlice);
	return (
		<Root
			content={
...
export default withSlices([rejectionReasonSlice])(memo(OrderRejection));
