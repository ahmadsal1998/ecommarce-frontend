...
/**
 * The Root styled component is used to style the root div of the EscSvgIcon component.
 * It uses the styled function from the MUI styles library to create a styled component.
 */
const Root = styled(Box)<EscSvgIconProps>(({ theme, size = 24, color = 'inherit' }) => ({
	width: size,
	height: size,
	minWidth: size,
	minHeight: size,
...
/**
 * The EscSvgIcon component is responsible for rendering an SVG icon with a specified size and color.
 * It uses various MUI components to render the icon.
 * The component is memoized to prevent unnecessary re-renders.
 */
const EscSvgIcon = forwardRef<SVGSVGElement, EscSvgIconProps>((props, ref) => {
