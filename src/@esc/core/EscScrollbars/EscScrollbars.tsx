...
import { selectCustomScrollbarsEnabled } from '@esc/core/EscSettings/store/escSettingsSlice';
...
/**
 * EscScrollbars Component for app-level scrollbar
 * Unlike normal scrollbars, this component supports mobile device as well
 */
const EscScrollbars = forwardRef<HTMLDivElement, EscScrollbarsProps>((props, ref) => {
	const {
		className = '',
		children,
		id = '',
	...
	const hookUpEvents = useCallback(() => {
		Object.keys(handlerNameByEvent).forEach((key) => {
			const callback = props[handlerNameByEvent[key] as keyof EscScrollbarsProps] as (T: HTMLDivElement) => void;
