...
type EscNavHorizontalGroupProps = EscNavItemComponentProps & WithRouterProps;

/**
 * EscNavHorizontalGroup.
 * Represents a horizontal group component used in the Esc navigation navigation list.
 * It shows the list item as well as its children with a flyout effect.
 */
function EscNavHorizontalGroup(props: EscNavHorizontalGroupProps) {
...
const NavHorizontalGroup = withRouter(memo(EscNavHorizontalGroup));
