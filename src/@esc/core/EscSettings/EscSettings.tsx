import { useDebounce, usePrevious } from '@esc/hooks';
...
import ThemeFormConfigTypes from '@esc/core/EscSettings/ThemeFormConfigTypes';
...
/**
 * The Root styled component is used to style the root div of the EscSettings component.
 * It uses the styled function from the MUI styles library to create a styled component.
 */
const Root = styled('div')(({ theme }) => ({
	'& .EscSettings-formControl': {
		margin: '6px 0',
		width: '100%',
		'&:last-child': {
			marginBottom: 0
...
export type EscThemeType = {
	palette: PartialDeep<Palette>;
};

export type EscThemesType = { [key: string]: EscThemeType };

export type EscSettingsConfigType = {
	layout: {
		style?: string;
...
/**
 * The Escs ettings component is responsible for rendering the settings form for the Esc React application.
...
function EscSettings() {
	...
	const handleUpdate = useDebounce((newSettings: EscSettingsConfigType) => {
				...
				switch (formControl.type) {
						...
						return (
							<Controller
								...
								render={({ field }) => (
									<FormControl
										component="fieldset"
										className="EscSettings-formControl"
									>
										<FormLabel
											component="legend"
											className="text-14"
					...
					case 'group': {
						return (
							<div
								key={target}
								className="EscSettings-formGroup"
							>
								<Typography
									className="EscSettings-formGroupTitle"
	...
	return (
		<Root>
			<div className="EscSettings-formGroup">
				<Typography
					className="EscSettings-formGroupTitle"
					color="text.secondary"
				>
			...
			<div className="EscSettings-formGroup pb-16">
				<Typography
					className="EscSettings-formGroupTitle"
					color="text.secondary"
				>
...
export default memo(EscSettings);
