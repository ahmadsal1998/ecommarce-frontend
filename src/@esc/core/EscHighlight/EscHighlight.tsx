 ...
 */
const EscHighlight = forwardRef<HTMLDivElement, EscHighlightProps>((props, ref) => {
...
function trimCode(children: EscHighlightProps['children']) {
	...
	// can be formatted properly while using esc-highlight
	// component
...
export default memo(styled(EscHighlight)``);
