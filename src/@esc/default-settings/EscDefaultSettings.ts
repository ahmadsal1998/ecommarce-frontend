import { escDark } from '@esc/colors';
...
/**
 * The defaultSettings object defines the default settings for the Esc application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the eSC application.
 * It returns a EscSettingsConfigType object that can be used to configure the application.
 */
export function getParsedQuerySettings() {
	...
	if (typeof defaultSettings === 'string') {
		...
		return JSON.parse(defaultSettings) as EscSettingsConfigType;
	}
